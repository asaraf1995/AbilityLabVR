...
public class _WalkRight : MonoBehaviour
{
    ...
    public void OnTriggerEnter(Collider collision)
    {
        ...
        {
            if (_WalkLeft.right.Contains(col.name))
            {
            }
            else
            {
                _WalkLeft.right.Add(col.name);
            }
        ...
        {
            if (_WalkLeft.wrong.Contains(col.name) || _WalkLeft.right.Contains(col.name))
            { }
            else
            {
                _WalkLeft.wrong.Add(col.name);
            }
    ...
    public void resetDictionary()
    {
        ...
        _WalkLeft.right.Clear();
        _WalkLeft.wrong.Clear();

    }
    public void setScoreText()
    {
        ScoreText.text = "Score: " + (_WalkLeft.right.Count - _WalkLeft.wrong.Count).ToString();
    }
